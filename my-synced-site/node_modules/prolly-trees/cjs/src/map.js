...
class MapLeaf extends base.IPLDLeaf {
  get(key) {
...
class MapBranch extends base.IPLDBranch {
  get(key) {
    return getValue(this, key);
  }
  getMany(keys) {
...
exports.MapBranchEntry = MapBranchEntry;
exports.MapLeaf = MapLeaf;
exports.MapLeafEntry = MapLeafEntry;
