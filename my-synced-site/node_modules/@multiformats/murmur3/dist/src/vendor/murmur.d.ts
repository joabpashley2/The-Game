 ...
 */
export function murmurHash3_x64_128(key: Uint8Array, seed?: number): Uint8Array<ArrayBuffer>;
/**
 ...
 * @returns {Uint8Array<ArrayBuffer>} the hash value as 16 bytes
 */
export function murmurHash3_x86_128(key: Uint8Array, seed?: number): Uint8Array<ArrayBuffer>;
/**
